    ...
    41 format('output/1d_res_',i0,'e',i0,'/')
    42 format('output/2d_res_',i0,'e',i0,'/')
    ...
    do
        ...
        !if (mod(ts,int(3)) == 0) then
            ...
            call savedat(trim(path)//'mui.dat', mui * x0**2 / phi0 / t0)
            call savedat(trim(path)//'ti.dat', Ti * phi0)
...
12 format('  Vd: ', f8.2, '  Id: ', es10.2, '  time/us:', f7.2, ' hr')   
